...
local function set_property_headers_vararg(self, set_header, ...)
  local count = select("#", ...)
  if count == 0 then
    return
  end
...
function metatable:set_request_headers(...)
  ...
  set_property_headers_vararg(self, set_request_header, ...)
end
...
function metatable:set_response_headers(...)
  ...
  set_property_headers_vararg(self, set_response_header, ...)
end
